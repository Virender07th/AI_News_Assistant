...
from app.Service.BiasDetection import generate_bias_detection
from app.Utiles.GetArticle import get_article# Your Pydantic model

router = APIRouter()

@router.post("/bias_detection" ,summary="Bias detection for a news article from topic or URL")
async def bias_detection(
    ...
    try:
        ...
        result = generate_bias_detection(article)
