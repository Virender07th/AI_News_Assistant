...
const recentActivity = [
  { title: "AI in Education.", date: "Generated on: 2024-07-21" },
  { title: "Notes", date: "Generated on: 2024-07-21" },
  { title: "Student Data", date: "Generated on: 2024-07-21" },
  { title: "Presentation", date: "Generated on: 2024-07-21" },
  { title: "Classroom", date: "Generated on: 2024-07-21" },
  { title: "Research", date: "Generated on: 2024-07-21" },
  { title: "Research", date: "Generated on: 2024-07-21" },
  { title: "Research", date: "Generated on: 2024-07-21" },
  { title: "Research", date: "Generated on: 2024-07-21" },
  { title: "Research", date: "Generated on: 2024-07-21" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center text-center space-y-3">
                  <div className={`p-3 rounded-full ${card.bgColor} ring-2 ring-white shadow-md`}>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/60 overflow-hidden">
          ...
          <div className="px-6 py-4 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-200/50">
            ...
            <p className="text-sm text-gray-600 mt-1">Latest updates from your AI news system</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <h3 className="text-lg font-semibold mb-2">Generate News</h3>
            <p className="text-blue-100 text-sm mb-4">Create AI-powered news articles</p>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <p className="text-purple-100 text-sm mb-4">Verify news accuracy with AI</p>
            <button className="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
              Start Checking
            </button>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <p className="text-green-100 text-sm mb-4">Analyze trending topics</p>
            <button className="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
              View Trends
            </button>
          </div>
